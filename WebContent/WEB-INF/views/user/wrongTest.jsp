                        ...
                        <div class="card-content">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <c:if test="${aqInfo.isright == '0'}">
										<c:forEach items="${aqInfo }" var="allQ" varStatus="status">
	                                        <tr class="odd gradeX">
												  ...
												  <td><c:out value="${allQ.qAnswer }"></c:out></td>
												  <td><c:out value="${allQ.yAnswer }"></c:out></td>
												  <td><c:out value="${allQ.answer5 }"></c:out></td>
	                                        </tr>
                                        </c:forEach>		
	                                </c:if>
