 ...
 * 将form表单元素的值序列化成对象
 * 
 * @example iflytek.serializeObject($('#formId'))
 * 
 * @author wuxw
 * 
 * @requires jQuery
 ...
 * @returns object
 */
iflytek.serializeObject = function(form) {
	var o = {};
...
var vcity={ 11:"北京",12:"天津",13:"河北",14:"山西",15:"内蒙古",  
  ...
  iflytek.identityCodeValid = function(card)  
{  
    //是否为空  
    if(card === '')  
    {  
...
iflytek.checkMobile = function (code) {  
...
* by xwwu
*/
iflytek.discriCard = function (card){
	//获取出生日期
